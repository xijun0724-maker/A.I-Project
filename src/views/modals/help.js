  ...
  modal({
    ...
    body: mdToHtml(
      [
        ...
        "Each assessment is decomposed into ordered subtasks with effort estimates and intermediate dates spread backwards from the deadline. Priority comes from deadline proximity, grade weighting and work remaining.",
        "",
        ...
        "The planner distributes remaining subtasks across your available study hours, the dashboard reports progress and workload, and recommendations update as you tick work off.",
        "",
